...
public final class NeoForgeConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        checkUpdateButton = addControlButton(controlX, y, Component.literal("检查更新"), button -> {
            if (draft.update.checkUpdates) {
                ...
                BakaPotatoUpdateChecker.markDisabled("neoforge", BakaPotatoPatcherNeoForgeClient.currentModVersion());
            }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (contentHeight > this.height - TOP - BOTTOM_PADDING) {
            graphics.centeredText(this.font, Component.literal("滚轮滚动查看更多配置"), this.width / 2, this.height - 40, 0x888888);
        }
    }
